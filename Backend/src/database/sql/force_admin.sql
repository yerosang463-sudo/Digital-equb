-- First, create/update the admin user with the correct password
...
-- Assign admin role to user ID 5 (yerosang463@gmail.com)
INSERT IGNORE INTO user_roles (user_id, role_id, assigned_by) VALUES (5, 1, 5);
